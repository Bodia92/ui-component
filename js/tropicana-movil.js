(self["webpackChunkglivera_webpack_template"] = self["webpackChunkglivera_webpack_template"] || []).push([["tropicana-movil"],{
...
/***/ "./src/pages/tropicana-movil/tropicana-movil.js":
/*!******************************************************!*\
  !*** ./src/pages/tropicana-movil/tropicana-movil.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tropicana_movil_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tropicana-movil.scss */ "./src/pages/tropicana-movil/tropicana-movil.scss");
...
/* harmony import */ var _js_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../js/utils */ "./src/js/utils/index.js");
/* harmony import */ var _js_utils_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../js/utils/constants */ "./src/js/utils/constants.js");
/* harmony import */ var _js_dev_vendors_dev_widget__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../js/dev-vendors/dev-widget */ "./src/js/dev-vendors/dev-widget.js");
...
// -------------------  dev widget
if (_js_utils_constants__WEBPACK_IMPORTED_MODULE_5__.ENV_STATUS.projectDevStatus) {
  (0,_js_dev_vendors_dev_widget__WEBPACK_IMPORTED_MODULE_6__["default"])();
}
// -------------------  dev widget###
...
var clearSectionClass = function clearSectionClass(slider, section) {
  if (section.classList.contains("tropicana--color_v".concat(slider.previousIndex, "_mod"))) {
    section.classList.remove("tropicana--color_v".concat(slider.previousIndex, "_mod"));
  }
};
function initSlider() {
  var section = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '.js-section-tropicana';
  var $section = document.querySelector(section);
  if (!$section) return;
  var $slider = $section.querySelector('.swiper');
  var $pagination = $section.querySelector('.slider_bullets');
  var $totalSlide = $section.querySelector('.slider_fraction__total');
  var $currentSlide = $section.querySelector('.slider_fraction__current');
  if (!(0,_js_utils__WEBPACK_IMPORTED_MODULE_4__.exist)([$slider, $pagination, $totalSlide, $currentSlide])) return;
  ...
  /*eslint-disable*/
  $totalSlide.innerHTML = String(slider.slides.length).padStart(2, '0');
  slider.on('slideChange', function () {
    var currentSlide = ++slider.realIndex;
    $currentSlide.innerHTML = String(currentSlide).padStart(2, '0');
    if ($section.classList.contains("tropicana--color_v".concat(slider.previousIndex, "_mod"))) {
      $section.classList.remove("tropicana--color_v".concat(slider.previousIndex, "_mod"));
    }
    $section.classList.add("tropicana--color_v".concat(slider.activeIndex, "_mod"));
  });
}
function loadFunc() {
  initSlider();
}
(0,_js_utils__WEBPACK_IMPORTED_MODULE_4__.pageLoad)(function () {
  loadFunc();
});
...
/***/ "./src/pages/tropicana-movil/tropicana-movil.scss":
/*!********************************************************!*\
  !*** ./src/pages/tropicana-movil/tropicana-movil.scss ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ var __webpack_exports__ = (__webpack_exec__("./src/pages/tropicana-movil/tropicana-movil.js"));
/******/ }
]);
//# sourceMappingURL=tropicana-movil.js.map