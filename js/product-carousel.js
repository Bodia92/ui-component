(self["webpackChunkglivera_webpack_template"] = self["webpackChunkglivera_webpack_template"] || []).push([["product-carousel"],{
...
/***/ "./src/pages/product-carousel/product-carousel.js":
/*!********************************************************!*\
  !*** ./src/pages/product-carousel/product-carousel.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _product_carousel_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./product-carousel.scss */ "./src/pages/product-carousel/product-carousel.scss");
/* harmony import */ var _js_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../js/utils */ "./src/js/utils/index.js");
/* harmony import */ var _js_utils_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../js/utils/constants */ "./src/js/utils/constants.js");
/* harmony import */ var _js_dev_vendors_dev_widget__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../js/dev-vendors/dev-widget */ "./src/js/dev-vendors/dev-widget.js");
...
// -------------------  dev widget
if (_js_utils_constants__WEBPACK_IMPORTED_MODULE_4__.ENV_STATUS.projectDevStatus) {
  (0,_js_dev_vendors_dev_widget__WEBPACK_IMPORTED_MODULE_5__["default"])();
}
// -------------------  dev widget###
...
var slider = function slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    ...
    sectionSelector = _ref$sectionSelector === void 0 ? '.js-slider-section' : _ref$sectionSelector,
    _ref$sliderSelector = _ref.sliderSelector,
    sliderSelector = _ref$sliderSelector === void 0 ? '.js-slider-swiper' : _ref$sliderSelector,
    _ref$btnNextSelector = _ref.btnNextSelector,
    btnNextSelector = _ref$btnNextSelector === void 0 ? '.js-slider-next-button' : _ref$btnNextSelector,
    _ref$btnPrevSelector = _ref.btnPrevSelector,
    btnPrevSelector = _ref$btnPrevSelector === void 0 ? '.js-slider-prev-button' : _ref$btnPrevSelector,
    _ref$paginationSelect = _ref.paginationSelector,
    paginationSelector = _ref$paginationSelect === void 0 ? '.js-slider-pagination' : _ref$paginationSelect,
    _ref$slideEl = _ref.slideEl,
    slideEl = _ref$slideEl === void 0 ? '.js-slider-slide' : _ref$slideEl,
    _ref$activeSlide = _ref.activeSlide,
    activeSlide = _ref$activeSlide === void 0 ? '.swiper-slide-active' : _ref$activeSlide,
    _ref$prevSlide = _ref.prevSlide,
    prevSlide = _ref$prevSlide === void 0 ? '.swiper-slide-prev' : _ref$prevSlide,
    _ref$nextSlide = _ref.nextSlide,
    nextSlide = _ref$nextSlide === void 0 ? '.swiper-slide-next' : _ref$nextSlide,
    _ref$titleSlide = _ref.titleSlide,
    titleSlide = _ref$titleSlide === void 0 ? '.product_carousel__item_title' : _ref$titleSlide,
    _ref$imageSlide = _ref.imageSlide,
    imageSlide = _ref$imageSlide === void 0 ? '.product_carousel__item_pic' : _ref$imageSlide,
    _ref$decorSlide = _ref.decorSlide,
    decorSlide = _ref$decorSlide === void 0 ? '.product_carousel__item_decor' : _ref$decorSlide,
    _ref$priceSlide = _ref.priceSlide,
    priceSlide = _ref$priceSlide === void 0 ? '.product_carousel__item_price' : _ref$priceSlide;
  var $sections = document.querySelectorAll(sectionSelector);
  if (!(0,_js_utils__WEBPACK_IMPORTED_MODULE_3__.exist)($sections)) return;
  ...
  $sections.forEach(function ($section) {
    ...
    var $slide = $section.querySelectorAll(slideEl);
    var prevProgress = 0;
    var nextProgress = 0;
    var transitionInterval = null;
    if (!(0,_js_utils__WEBPACK_IMPORTED_MODULE_3__.exist)([$slider, $btnNext, $btnPrev])) return;

    // const tl = gsap.timeline({
    // 	paused: true,
    // 	onUpdate: () => {
    // 		if (prevProgress < nextProgress && nextProgress > tl.progress()) {
    // 			console.log('pause');
    // 			tl.play();
    // 		} else if (prevProgress >= nextProgress && nextProgress > tl.progress()) {
    // 			tl.pause();
    // 		}
    ...
    // 	const $title = slide?.querySelector('.product_carousel__item_title');
    // 	// const $image = slide?.querySelector('.product_carousel__item_pic');
    // 	// const $decor = slide?.querySelector('.product_carousel__item_decor');
    // 	// const $price = slide?.querySelector('.product_carousel__item_price');
    // 	// const $descr = slide?.querySelector('.product_carousel__item_description');
    // 	// const $btn = slide?.querySelector('.product_carousel__item_btn');
    // 	tl.addLabel(`slide_${index}`);
    ...
    // 	// 	tl.fromTo($price, { x: '15%', y: 0, scale: 1, opacity: 0 }, { x: 0, y: 0, scale: 1, opacity: 1, duration: 1, delay: 0.2, ease: 'power2.out' }, 0);
    // 	// 	tl.fromTo($image, { rotate: 0, x: '80%', y: 0, scale: 1, opacity: 1 }, { rotate: -45, x: 0, y: 0, scale: 1, opacity: 1, duration: 0.8, delay: 0.2, ease: 'power2.out' }, 0.2);
    // 	// 	tl.fromTo($decor, { rotate: 30, x: '80%', y: 0, scale: 1, opacity: 0 }, { rotate: 30, x: 0, y: 0, scale: 1, opacity: 1, duration: 1, delay: 0.2, ease: 'power2.out' }, 0.2);
    // 	// 	tl.to(($descr, $btn), { opacity: 1, duration: 0.5, ease: 'power2.out' }, 0);
    // });
    // tl.progress(0.5).play('>').progress(1);
    // tl.play();

    var slides = document.querySelectorAll('.js-slider-slide');
    // eslint-disable-next-line no-plusplus
    for (var i = 0; i < slides.length; i++) {
      if (i === swiper__WEBPACK_IMPORTED_MODULE_0__["default"].activeIndex) {
        slides[i].classList.remove('inactive');
      } else {
        slides[i].classList.add('inactive');
      }
    }
    var slideNextTransitionStartAnim = function slideNextTransitionStartAnim(sliderEl) {
      var $activeSlide = sliderEl === null || sliderEl === void 0 ? void 0 : sliderEl.querySelector(activeSlide);
      var $title = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(titleSlide);
      var $image = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(imageSlide);
      var $decor = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(decorSlide);
      var $price = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(priceSlide);
    ...
    var slideNextTransitionStartAnim2 = function slideNextTransitionStartAnim2(sliderEl) {
      var $activeSlide = sliderEl === null || sliderEl === void 0 ? void 0 : sliderEl.querySelector(prevSlide);
      var $title = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(titleSlide);
      var $image = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(imageSlide);
      var $decor = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(decorSlide);
      var $price = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(priceSlide);
    ...
    var slidePrevTransitionStartAnim3 = function slidePrevTransitionStartAnim3(sliderEl) {
      var $activeSlide = sliderEl === null || sliderEl === void 0 ? void 0 : sliderEl.querySelector(activeSlide);
      var $title = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(titleSlide);
      var $image = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(imageSlide);
      var $decor = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(decorSlide);
    ...
    var slideNextTransitionStartAnim4 = function slideNextTransitionStartAnim4(sliderEl) {
      var $activeSlide = sliderEl === null || sliderEl === void 0 ? void 0 : sliderEl.querySelector(nextSlide);
      var $title = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(titleSlide);
      var $image = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(imageSlide);
      var $decor = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(decorSlide);
      var $price = $activeSlide === null || $activeSlide === void 0 ? void 0 : $activeSlide.querySelector(priceSlide);
    ...
    var productSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]($slider, {
      ...
      on: {
        // progress(swiper) {
        // 	console.log('---');
        // 	console.log(Math.floor(prevProgress, 2));
        // 	console.log(Math.floor(nextProgress, 2));
        // 	nextProgress = swiper.progress;
        ...
        slideNextTransitionStart: function slideNextTransitionStart() {
          slideNextTransitionStartAnim(this.el);
          slideNextTransitionStartAnim2(this.el);
        },
        slidePrevTransitionStart: function slidePrevTransitionStart() {
          slidePrevTransitionStartAnim3(this.el);
          slideNextTransitionStartAnim4(this.el);
        }
      }
    });
  });
...
(0,_js_utils__WEBPACK_IMPORTED_MODULE_3__.pageLoad)(function () {
  loadFunc();
});
...
/***/ "./src/pages/product-carousel/product-carousel.scss":
/*!**********************************************************!*\
  !*** ./src/pages/product-carousel/product-carousel.scss ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ var __webpack_exports__ = (__webpack_exec__("./src/pages/product-carousel/product-carousel.js"));
/******/ }
]);
